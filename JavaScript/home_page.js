...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const scoreElement = document.getElementById("user-score"); // Safely get the score element
  const lastPlayedElement = document.getElementById("last-played"); // Safely get the last-played element
  ...
  scoreElement.textContent = userStats[loggedInUser].totalScore;
  lastPlayedElement.textContent = userStats[loggedInUser].lastPlayed;
